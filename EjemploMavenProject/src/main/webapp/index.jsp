...
width=250px height=250px>
			...
			<ul>
				...
				<a href="ListComic" class="lista">Mostrar todos los Comics</a>
				</li>
				<li><img src="http://c.dryicons.com/images/icon_sets/luna_blue_icons/png/128x128/add.png"
				width=32px height=32px>
				<a href="/EjemploMavenProject/AddComic.jsp" class="lista">Agregar Comic</a></li>
				
			</ul>
			<ul>
				<li><img src="https://cdn4.iconfinder.com/data/icons/ios7-active-basic/512/todo_list_text_document-128.png"
				width=32px height=32px>
				<a href="ListPerson" class="lista">Mostrar todas las Personas</a></li>
				<li><img src="http://c.dryicons.com/images/icon_sets/luna_blue_icons/png/128x128/add.png"
				width=32px height=32px>
