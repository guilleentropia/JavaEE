...
<c:forEach var="b" items="${lista}">
			...
			<td>${b.descripcion}</td>
			<td width=50px>
				 <form name = "modificar" method="get" action="UpdateRol" class="acciones">
					<a href="/EjemploMavenProject/UpdateRol?Id=${b.idRol}">
			...
			<td width=50px> 
				<form name = "eliminar" method="get" action="DeleteRol" class="acciones">
					<a href="/EjemploMavenProject/DeleteRol?Id=${b.idRol}">
