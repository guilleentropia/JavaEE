	...
	<table>
		...
		<c:forEach var="b" items="${lista}">
			...
			<tr>
				...
				<td width=50px>
					<form name="modificar" method="get" action="UpdateLogin"
						class="acciones">
						<a href="/EjemploMavenProject/UpdateLogin?Id=${b.idLogin}"> <img
				...
				<td width=50px>
					<form name="eliminar" method="get" action="DeleteLogin"
						class="acciones">
						<a href="/EjemploMavenProject/DeleteLogin?Id=${b.idLogin}"> <img
