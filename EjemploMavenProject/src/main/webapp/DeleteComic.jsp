...
<body>
	<form method="post" action="DeleteComic" class="form">
		<p>Eliminar Comic</p>
		<div class="contiene">
			<fieldset>
				<br>
				...
				<div style="color: black">
					<label for="nameComic">Nombre</label> <input name="Name" id="Name"
						disabled value="${comic.nameComic}" /><br>
					<br>
				</div>

				<div style="color: black">
					<label for="companyComic">Compania</label> <input name="Company"
						id="Company" disabled value="${comic.companyComic}" /><br>
					<br>
				</div>

				<div style="color: black">
					<label for="reviewComic">Review</label> <input name="Review"
						id="Review" disabled value="${comic.reviewComic}" /> <br>
					<br>
